...
sub USAGE ( ) {
  ...
  The output is to a module Tables.pm6 with the following output

        use v6.c;
         unit package Unicode;
         module PRECIS::Tables::<module-name> {
  ...
  The table is optional and is generated by the --table option.
  ...
  Arguments
    ...
    filename-path       Path to filename relative to the ucd-dir.
  ...
  Options:
    --cat               This is a list of comma separated strings. These
                        ...
                        When it is '*', all catagories are to be gathered.

    --cat-field=<Int>   This is the fieldnumber which is to be compared with
                        the list from the --cat option. By default the value
                        is 1 to compare the second field with --cat,
    --fields            A list of comma separated fieldnames by which the
                        keys in the hash table are to be named. Fields can be
                        skipped by not naming them. E.g. codepoint,,catagory.
                        When --fields is not present, nothing is saved but the
                        codepoints. This is useful when only a set is needed.

    --help              This information.
    -h

    --mod-name=<Str>    Name of the class generated.
  ...
  Examples
    ...
    > generate-module --mod-name='NonCharCodepoint' \
                      --cat='Noncharacter_Code_Point' --table \
